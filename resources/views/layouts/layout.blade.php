                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    <li><a href="#"><i class="fa fa-phone"></i> +2 01 06 94 730</a></li>
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    <li>
                                @if( auth()->check() )
                                    <a href="{{ url('account') }}"><i class="fa fa-user"></i> 
                                      {{ auth()->user()->name }}
                                    </a>
                                    </li>
                                ...
                                @else
                                    <a href="login"><i class="fa fa-user"></i>Account</a></li>
                                    <li><a href="{{url('/login')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                    <li><a href="{{url('/login')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    <li>
                                        <a href="{{url('/')}}" {{$page == 'home' ? 'class=active' : ''}}>
                                            Home
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{url('/products')}}" {{$page == 'products' ? 'class=active' : ''}}>
                                        Products
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{url('/blog')}}" {{$page == 'blog' ? 'class=active' : ''}}>Blog</a>
                                    </li>
                                    <li>
                                        <a href="{{url('contact-us')}}" {{$page == 'contact_us' ? 'class=active' : ''}}>Contact Us</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
